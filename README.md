...
منبع اصلی و در حال حاضر، مورد استفاده لغت نامه را میتوانید در فولدر [db](https://github.com/hossein1376/English-Persian-Kindle-Custom-Dictionary/tree/main/db) پیدا کنید. استفاده و انتشار **غیر تجاری** منبع کاملا مجاز و رایگان میباشد. اضافه شدن کلمات جدید و اضافه کردن صرف برای بیش از بیست هزار کلمه و فعل، بهبود و اصلاح ترجمه، تبدیل به فرمت مناسب آمازون و انتشار لغت نامه توسط من انجام شده است. 
